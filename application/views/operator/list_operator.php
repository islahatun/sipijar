                    ...
                    foreach ($list as $l) : ?>
                        <tr>
                            ...
                            <td class="text-center">
                                ...
                                <a href="<?= base_url('Operator/delete_operator/' . $l['id_pns']) ?>" class="btn btn-danger"><i class="far fa-trash-alt"></i> HAPUS</a>
                            </td>
                        </tr>
                        <?php $i++ ?>
                    <?php endforeach; ?>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="<?= base_url('Operator/insert_operator') ?>" method="post">
                        <div class="row  ">
